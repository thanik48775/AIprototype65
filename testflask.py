...
def home2():
    ...
    return render_template("home.html",name = 'First')#,name = 'Tohn', fav = name)
    
if __name__ == "__main__":
    app.run(host='0.0.0.0',debug=True,port=5005)#host='0.0.0.0',port=5001